...
![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-1.png)

前面这个长方体是缩放未使用应用缩放命令，后边的长方体是应用过缩放命令。两个立方体分别选择一个边倒角后，没有应用过变换命令的长方体倒角被拉伸；使用倒角生成器进行统一倒角后未使用应用缩放也产生了严重的倒角拉伸。

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-2.png)

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-3.png)

#### 编辑模式下内插面、法线挤出面、新建对象缩放的问题

内插面因为在物体模式下缩放导致边距不均匀

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-4.png)

法线挤出面勾选均等偏移依然不均等问题

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-5.png)

#### UV拉伸问题

给立方体创建默认材质→赋予默认的棋盘格纹理，正常如下图

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-6.png)

刚才创建正常的立方体进行Y轴放大2倍，观察棋盘格纹理发现已经被拉伸得严重

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-7.png)
...
![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-8.png)
...
![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-9.png)

#### 网格的概念

Blender创建一个猴头可以在大纲视图中展开网格对象，看到一个绿色三角形标志写着猴头，这个就是网格。

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-10.png)
...
![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-11.png)

复制这个立方体到旁边（称为2号立方体），按Ctrl+A 应用缩放，在物体模式可以看到缩放的坐标是X1、Y1、Z1,此时2号立方体的大小是X轴2米，Y轴6米，Z轴2米

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-12.png)

接下来分别给两个立方体添加一个倒角生成器，倒角数值是0.1，可以看到1号立方体倒角出现了拉伸的问题，2号立方体倒角正常。

![](https://feirenx-1302537874.file.myqcloud.com/img/BL004-13.png)
